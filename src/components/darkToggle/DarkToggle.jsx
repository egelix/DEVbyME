...
function DarkToggle({ darkMode, setDarkMode }) {
  ...
  return (
    <div onClick={handleToggleModeClick} className="z-20 fixed top-24 right-0 inline-block w-12 cursor-pointer rounded-l-lg bg-zinc-800 dark:bg-zinc-200 dark:text-black text-zinc-200 p-2 text-3xl">
