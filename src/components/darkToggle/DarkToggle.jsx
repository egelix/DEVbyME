...
function DarkToggle({ darkMode, setDarkMode }) {
  ...
  return (
    <div onClick={handleToggleModeClick} className="z-40 fixed top-24 right-0 inline-block w-10 md:w-12 lg:w-14 cursor-pointer rounded-l-lg bg-zinc-800 dark:bg-zinc-200 dark:text-black text-zinc-200 p-2 text-3xl">
